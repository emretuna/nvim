...
add {
    ...
    'b0o/schemastore.nvim', 'folke/lazydev.nvim', 'folke/neoconf.nvim'}
}
...
require('lazydev').setup {
    library = {'mini.nvim', 'MiniDeps', -- Load luvit types when the `vim.uv` word is found
    {
        ...
        intelephense = {
            ...
            settings = {
                intelephense = {
                    ...
                    stubs = {'acf-pro', 'bcmath', 'bz2', 'calendar', 'Core', 'curl', 'date', 'exif', 'json', 'genesis',
                             'polylang', 'Relection', 'wordpress', 'wordpress-globals', 'woocommerce', 'wp-cli', 'zip',
                             'zlib'},
                    diagnostics = {
                        enable = true
                    },
...
vim.list_extend(ensure_installed, {'blade-formatter', 'cssls', 'css_variables', --  'deno',
'dockerls', 'docker_compose_language_service', -- 'emmet-ls',
'eslint_d', -- js linter
'graphql', 'html', 'harper-ls', 'intelephense', 'jq', 'jsonls', -- 'kulala_ls',
'lua_ls', 'markdownlint', 'php-cs-fixer', 'phpstan', 'phpcbf', 'phpcs', 'postgrestools', 'pint', 'prettier', -- prettier formatter
                                   'prettierd', -- prettier daemon
'prismals', 'stylua', -- Used to format Lua code
'sqlls', 'tailwindcss', 'typos', 'yamlls'})
